...
export  default {
  ...
  addNewList: async function (params) {
    return request({
      ...
      dataType: 'json',
      url: '/api/conduct/v1.0/startConduct',
      data: params,
      method: 'post',
    })
  },
  ...
  senChangeFileUrl: async function (params) {
    return request({
      contentType: false,//这里不要落下
      dataType: 'json',
      url: '/api/conduct/v1.0/updateConduct',
      data: params,
      method: 'post',
    })
  },
  ...
  selectALL:async function (params) {
    return request({
      url: '/api/conduct/v1.0/transFlowGet?' + qs.stringify(params),
      method: 'get',
    })
  },
  selectALLInfoUrl:async function (params) {
    return request({
      url: '/api/conduct/v1.0/taskList?' + qs.stringify(params),
      method: 'get',
    })
  },
  dealtList:async function (params) {
    return request({
      url: '/api/conduct/v1.0/dealtList?' + qs.stringify(params),
      method: 'get',
    })
  },
  getInitTransFlow: async function () {
    return request.get('/api/conduct/v1.0/initTransFlow')
  },
  ...
  getRelation:async function (conductId,relationType) {
    return request.get('/api/conduct/v1.0/getConductRelations?conductId='+conductId+'&relationType='+relationType)
  },
  ...
  getDetails:async function (procInstId,xmlId) {
    return request.get('/api/conduct/v1.0/'+procInstId+'/'+xmlId+'/getParallelTask')
  },
  // 获取当前step的信息
