...
export  default {
  ...
  updateDataSource: async function (params) {
    return request({
      url: '/api/trade/stock/saveOrModify.do',
      method: 'post',
  ...
  deleteDataSource: async function (params) {
    return request({
      url: '/api/trade/stock/deleteById.do' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
  ...
  pass: async function (params) {
    return request({
      url: '/api/trade/stock/pass' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
  // 反审核
  unpass: async function (params) {
    return request({
      url: '/api/trade/stock/unpass' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
