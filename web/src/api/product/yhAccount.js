...
export  default {
  ...
  updateDataSource: async function (params) {
    return request({
      url: '/api/trade/bond/saveOrModify.do',
      method: 'post',
  ...
  deleteDataSource: async function (params) {
    return request({
      url: '/api/trade/bond/deleteById.do' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
  ...
  pass: async function (params) {
    return request({
      url: '/api/trade/bond/pass' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
  // 反审核
  unpass: async function (params) {
    return request({
      url: '/api/trade/bond/unpass' + '?' + qs.stringify(params),
      method: 'post',
    })
  },
