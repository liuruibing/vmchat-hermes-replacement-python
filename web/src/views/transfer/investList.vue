<template>
  <div>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.isSend==1">是</span>
    ...
    >
      <bizBeginPage
        ...
        @investCheckClick="investCheckClick"
      >
      </bizBeginPage>
    </el-dialog>
    <!-- drawer组件 -->
...
import bizBeginPage from "@/views/invest/bizBegin.vue";
...
export default {
  ...
  data(data) {
    return {
      ...
      isHaveData: true,
      pageData: {
        pauseCode: "invest.update.Pause",
        unPauseCode: "invest.update.UnPause",
        abandonCode: "invest.update.Abandon",
        cancleCode: "invest.update.Cancle",
        normalCode: "invest.update.Normal",
        retireCode: "invest.update.Retire",
      },
    };
  },
  created(){
    tableMethod.fetTableHeight(this,'investTable');
  },
  activated(){
    this.fetTableHeight();
  ...
  methods: {
    ...
    openDrawer(data, flag) {
      ...
      this.$nextTick(() => {
        if(this.$refs.openDrawerRelation){
    ...
    initHandle() {
      ...
      let arr3 = [
        ...
        { name: "托管转中债", code: "gm050201" },
        { name: "中债转托管", code: "gm050202" },
        { name: "托管转上清", code: "gm050203" },
        { name: "上清转托管", code: "gm050204" },
        { name: "中债转上清", code: "gm050205" },
        { name: "上清转中债", code: "gm050206" },
      ];
