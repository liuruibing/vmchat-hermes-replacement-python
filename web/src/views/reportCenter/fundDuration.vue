<template>
 ...
 <div class="forms_table_title">
      <i class="el-icon-s-data"></i>存续期基金基本情况
    </div>
    <!-- sortable='custom' -->
 <el-table
      ref="multipleTable"
    ...
    >
      ...
      <el-table-column
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.JJLX | noDataFilter}}</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="CREATEDATE"
      ...
      <el-table-column
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.EDATE | noDataFilter}}</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="GM"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.GM | moneyMillion}}</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="SM"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.SM | moneyMillion}}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column
        prop="TZBD"
      ...
      <el-table-column
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.FEJZ | moneyThousand}}</span>
        </template>
      </el-table-column>
       <!-- <el-table-column
        prop="JGSL"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.JGSL | noDataFilter}}</span>
        </template>
      </el-table-column> -->
      <!-- <el-table-column
        prop="JGSJJE"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.JGSJJE | moneyMillion}}</span>
        </template>
      </el-table-column> -->
      <!-- <el-table-column
        prop="GRSL"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.GRSL | noDataFilter}}</span>
        </template>
      </el-table-column> -->
      <!-- <el-table-column
        prop="GRSJJE"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.GRSJJE | moneyMillion}}</span>
        </template>
      </el-table-column> -->
      <!-- <el-table-column
        prop="TG"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.TG | noDataFilter}}</span>
        </template>
      </el-table-column> -->
      <el-table-column
        prop="TGR"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.TGR | noDataFilter}}</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="FJ"
        ...
        align = "left">
        <template slot-scope="scope">
          <span>{{scope.row.FJ | noDataFilter}}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column
        prop="RATE"
...
<script>
 ...
 import pageApi from "@/api/reportCenter/fundDuration";
 import $ from 'jquery'
export default {
    name: 'fundDuration',
    components: {
