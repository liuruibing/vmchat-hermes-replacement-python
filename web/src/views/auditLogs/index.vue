<template>
  ...
  <div class="auditLogs analyse-page" v-auto-enter>
    ...
    <el-row>
      <el-col :span="16">
        <div class="page-model-title">
          ...
          <span class="title-txt">操作日志-汇总</span>
        </div>
      </el-col>
<!--      <el-col :span="8">
    ...
    <el-row id="standard-table">
      <div id="standard-table-margin">
        ...
        >
          ...
          <vxe-table-column field="cnt" title="访问次数" min-width="250" header-align="center" align="center" />
...
export default {
  ...
  methods: {
    ...
    downloadTableExcel() {
      ...
      const fileName = '操作日志-汇总.xlsx'
      const url = '/api/AuditLogs/select/export'
