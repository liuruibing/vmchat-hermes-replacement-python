<template>
  <div class="group-list-mananger">
    <el-aside :width="boxWidth" class="productAndProperty_virtual">
      <div style="height: 100%">
        <!-- <div :class="screenHeight >= 1080 ? 'tradeSeatAdjust-1080' : 'tradeSeatAdjust'"> -->
        <div class="tree-content">
          <el-tree ref="treeRef" class="standard-tree" :props="defaultProps" :data="groupData" node-key="pid" @node-click="handleNodeClick">
...
import { delManagerPool } from '../scripts/api'
import groupEdit from './group-edit-manager.vue'
export default {
  components: {
    groupEdit
  },
