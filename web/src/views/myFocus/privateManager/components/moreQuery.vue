    ...
    <el-form ref="queryForm" :inline="true" class="standard-form" :model="clsjSection" :rules="searchRules" label-position="left" size="small">
      ...
      <el-row class="gslx">
        <el-form-item label="公司类型" label-width="70px" style="display: flex; align-items: center">
          <span class="gslxbx" style="font-size: 14px; padding: 4px 10px" @click="handleBxBtn('.gslxbx')">不限</span>
          <span v-for="ele in companyType" :key="ele.id" :class="ele.checked ? 'itemBox-checked' : 'itemBox'">
            <el-checkbox v-model="ele.checked" :label="ele.label" @change="companyTypeChange($event, '.gslxbx', ele)" />
          </span>
        </el-form-item>
      </el-row>
      <!--  公司状态 / 备案状态 -->
      <el-row class="gsbazt">
        <el-form-item label="公司状态" label-width="70px" style="display: flex; align-items: center">
          <span class="gsztbx" style="font-size: 14px; padding: 4px 10px" @click="handleBxBtn('.gsztbx')">不限</span>
          <span v-for="ele in companyState" :key="ele.id" :class="ele.checked ? 'itemBox-checked' : 'itemBox'">
            <el-checkbox v-model="ele.checked" :label="ele.label" @change="companyStateChange($event, '.gsztbx', ele)" />
          </span>
        </el-form-item>
        <el-form-item label="备案状态" label-width="70px" style="display: flex; align-items: center">
          <span class="baztbx" style="font-size: 14px; padding: 4px 10px" @click="handleBxBtn('.baztbx')">不限</span>
          <span v-for="ele in recordsState" :key="ele.id" :class="ele.checked ? 'itemBox-checked' : 'itemBox'">
            <el-checkbox v-model="ele.checked" :label="ele.label" @change="companyRecordsState($event, '.baztbx', ele)" />
          </span>
        </el-form-item>
      </el-row>
      <!-- 策略类型 -->
        ...
        <el-form-item label="计算维度" label-width="70px" style="display: flex; align-items: center">
          <div style="display: flex; align-items: center">
            <div style="margin-right: 20px">
              <el-radio v-for="e in strategyType" :key="e.id" v-model="currentInvest" :label="e.id" border size="small" @input="strategyTypeChange">
                {{ e.label }}
              </el-radio>
              <el-tooltip class="table_header_icon ml10" effect="dark" placement="top">
                ...
                <i class="el-icon-question" style="color: #8f98a8; cursor: pointer"></i>
              </el-tooltip>
            </div>
          </div>
        </el-form-item>
      ...
      <el-row class="clsj">
        ...
        <el-form-item :class="clsjSection.style ? 'submit-icon' : 'submit-icon-disabled'">
          <el-button circle icon="el-icon-check" type="primary" @click="clsjSubmit" style="margin-right: 20px"></el-button>
        </el-form-item>
        <el-form-item v-for="e in cpzs" :key="e.mid" :label="e.title" :label-width="e.width" style="display: flex; align-items: center">
...
export default {
  ...
  methods: {
    ...
    handleBxBtn(val) {
      ...
      Dom.style.backgroundColor = '#e6edfc'
      Dom.style.color = '#1759b5'
      ...
      if (_index < 0 && checkedArr.length) {
        ...
        if (e === true) {
          ...
          if (!checkedArr.length) {
            ...
            DomBx.style.backgroundColor = '#e6edfc'
            DomBx.style.color = '#1759b5'
    ...
    reset() {
      ...
      this.$nextTick(() => {
        ...
        gslxBx.style.backgroundColor = '#e6edfc'
        gslxBx.style.color = '#1759b5'
        gslxBx.style.borderColor = '#dcdfe6'
        gsztBx.style.backgroundColor = '#e6edfc'
        gsztBx.style.color = '#1759b5'
        gsztBx.style.borderColor = '#dcdfe6'
        baztBx.style.backgroundColor = '#e6edfc'
        baztBx.style.color = '#1759b5'
