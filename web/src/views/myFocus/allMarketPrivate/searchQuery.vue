  ...
  <div id="dd-query">
    <div class="funds-filter">
      <div class="funds-filter-search">
        <el-form ref="searchFormALL" :inline="true" :model="simpleSearch" :rules="rules" class="standard-form">
          <el-form-item label="产品名称">
            <el-input v-model="simpleSearch.fundName" placeholder="产品名称/产品代码" size="small" style="width: 240px !important;" />
          </el-form-item>
          <el-form-item label="管理人">
            <el-input v-model="simpleSearch.managerName" placeholder="管理人名称" size="small" style="width: 180px !important;" />
          </el-form-item>
          <el-form-item label="管理规模区间"  v-show="false">
            <el-select v-model="simpleSearch.asset_list" placeholder="" size="small" clearable multiple collapse-tags @change="checkBoxfile">
              <el-checkbox v-model="isBx" :disabled="simpleSearch.asset_list.includes('不限')" style="display: inline-block; margin-left: 20px; padding: 3px 0" @change="bxChange">
                不限
              </el-checkbox>
          ...
          <div style="display: inline-block">
            <el-form-item label="截止日期" prop="endDate">
              <el-date-picker v-model="simpleSearch.endDate" :clearable="false" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" size="small" />
            </el-form-item>
            <el-form-item>
...
import defaultCts from './businessComp/epibolyQueryNew/constant'
...
export default {
  ...
  data() {
    return {
      simpleSearch: {...this.simpleSearchPro.simpleSearch
      },
      isParentSync: false,
      // 机构规模
      ...
      focusData: [],
      isBx: true,
      isMin: document.documentElement.clientWidth,
      rules: {
  ...
  async mounted() {
    ...
    window.onresize = () => {
      return (() => {
        this.isMin = document.documentElement.clientWidth
      })()
    }
  },
  methods: {
    ...
    async handleFindList(params) {
      ...
      if (this.$refs.searchFormALL) {
        this.$refs.searchFormALL.validate(async (valid) => {
          if (valid) {
