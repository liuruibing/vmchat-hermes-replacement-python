            ...
            <el-row>
              <el-col :span="12">
                ...
                >
                  ...
                  <select-table v-model="formCount.productId" :width="'600px'" @sendDataObj='dataObj' v-if="!isSearchData"></select-table>
    ...
    return {
      ...
      countRules: {
        ...
        accoNo: [
          ...
          {required: true,trigger: "blur",message:'请输入账户账号'}
        ],
        accoBank: [
          {
            type: "string",
        ...
        hvpsNo: [
          ...
          { required: true, trigger:'blur', message: "请输入大额支付系统号" }
        ],
        remark: [
          {
            required: false,
      ...
      this.$confirm("确定新增?", "提示", {
        ...
        .then(() => {
          ...
          if (this.fileList.length > 0) {
            ...
            formData.append("relaType", "tgh_file");
          }
          ...
          formData.append("accoType", "fiduciary");
          //relaType=tgh_file
          pageApi
