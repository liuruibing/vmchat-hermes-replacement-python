<template>
  <div class="setLog ddportal-ui">
    <el-form :inline="true" class="formQuery">
      <el-row>
        <el-col :span="16">
          <!-- 查询 -->
          <div class="grid-content bg-purple">
            <el-form-item label="编码" prop="vc_code">
        ...
        <el-col :span="8">
          <el-form-item class="search_button_com standard-form">
            ...
            <el-button type="info" plain size="small" icon="el-icon-delete" @click="allDelete">
              全部删除
            </el-button>
            <el-button plain type="info" icon="el-icon-delete" size="small" @click="deletall">
              批量删除
            </el-button>
          </el-form-item>
        </el-col>
    ...
    >
      ...
      >
        <!-- <template slot-scope="scope">
          <span v-if="scope.row.vc_result == '执行成功!'">{{scope.row.vc_result | noDataFilter}}</span>
      ...
      <el-table-column label="操作" min-width="100" align="center">
        <template slot-scope="scope">
          <el-button type="danger" plain size="small" @click="logCancle(scope.row)" v-if="scope.row.vc_run_status == 'RUNNING'">
            取消执行
          </el-button>
          <el-button type="danger" v-else plain size="small" @click="delData(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="明细日志" center :visible.sync="dialogMask" :close-on-click-modal="false">
      <el-container class="hg100">
        <el-main class="mainBox">
              ...
              <el-col :span="8">
                <div class="grid-content bg-purple-light">
                  <el-form-item class="search_button_com">
                    <el-button type="primary" :disabled="btnDisabled" class="mb5" icon="el-icon-search" style="float:right" size="small" @click="onQuery2(true)">
                      查询
                    </el-button>
                  </el-form-item>
                </div>
          ...
          <span class="title-style">任务明细列表</span>
          ...
          <el-table
            ...
            max-height="500"
          >
            <el-table-column prop="vc_code" show-overflow-tooltip label="任务编码" min-width="180" header-align="center" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.vc_code | noDataFilter }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="vc_name" show-overflow-tooltip label="任务名称" min-width="100" header-align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.vc_name | noDataFilter }}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="vc_result" label="日志详情" min-width="200" header-align="center">
              <template slot-scope="scope">
...
<script>
import commonApi from '@/api/etl/setLog'
    ...
    allDelete() {
      this.$confirm('确认删除这些数据吗?', '提示', {
        ...
        .then(() => {
          ...
          let params = { batchIdArr: '', vc_exec_type: 'MANUAL' }
