  ...
  <div class="setTask">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span
            v-if="scope.row.execStatusName == '未执行'"
            style="color: #909399"
            >{{ scope.row.execStatusName | noDataFilter }}</span
          >
          <span
            v-else-if="scope.row.execStatusName == '执行成功'"
            style="color: #67c23a"
            >{{ scope.row.execStatusName | noDataFilter }}</span
          >
          <span
            v-else-if="scope.row.execStatusName == '执行失败'"
            style="color: #f56c6c"
            >{{ scope.row.execStatusName | noDataFilter }}</span
          >
          <span
            v-else-if="scope.row.execStatusName == '有更新未执行' || scope.row.execStatus == '5'"
            style="color: #e6a23c"
            >有更新未执行</span
          >
