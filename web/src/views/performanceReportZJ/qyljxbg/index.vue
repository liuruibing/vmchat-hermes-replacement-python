...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportZJQYLJXBG',
      id: 'J_iframe_id_reportZJQYLJXBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/zjqyljxbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'd7de7862-9bb6-486f-a01a-5aac77e5790e',
          self.formInline.beginDate,
          self.formInline.endDate,
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'd7de7862-9bb6-486f-a01a-5aac77e5790e'
      const wordName = '权益类绩效报告.pdf'
