...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportXYPJFBSX',
      id: 'J_iframe_id_reportXYPJFBSX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'c4751dee-09da-4b14-b748-695c3a2385ee',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'c4751dee-09da-4b14-b748-695c3a2385ee'
      const wordName = '信用评级分布时序.pdf'
