...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportDCPQYBG',
      id: 'J_iframe_id_reportDCPQYBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'e4fdfbdc-d2e6-441e-bab2-248f2e3c61d4',
          self.formInline.beginDate,
          self.formInline.endDate,
          self.formInline.fundCode,
          '',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'e4fdfbdc-d2e6-441e-bab2-248f2e3c61d4'
      const wordName = '多产品权益报告.pdf'
