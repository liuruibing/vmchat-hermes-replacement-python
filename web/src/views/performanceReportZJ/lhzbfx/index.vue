...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportLHZBFX',
      id: 'J_iframe_id_reportLHZBFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '6aabf71e-9aea-4808-a561-81c587ffa2c1',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '6aabf71e-9aea-4808-a561-81c587ffa2c1'
      const wordName = '量化指标分析.pdf'
