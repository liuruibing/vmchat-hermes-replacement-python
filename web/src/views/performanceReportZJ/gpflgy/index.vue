...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportGPFLGY',
      id: 'J_iframe_id_reportGPFLGY',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'cc7c22e4-e780-456c-9360-7401e4edb3c1',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'cc7c22e4-e780-456c-9360-7401e4edb3c1'
      const wordName = '股票分类归因.pdf'
