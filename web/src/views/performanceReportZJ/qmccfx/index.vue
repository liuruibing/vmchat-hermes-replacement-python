              ...
              <el-row>
                <el-col :span="24">
                  <div class="grid-content bg-purple">
                    ...
                    <el-form-item label="日期" prop="endDate" class="mb20">
                      <el-date-picker size="small" v-model="formInline.endDate" type="date" value-format="yyyy-MM-dd" placeholder="选择日期"></el-date-picker>
                    </el-form-item>
                    <el-form-item class="">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportQMCCFX',
      id: 'J_iframe_id_reportQMCCFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'b92ac7a6-5025-42fa-921a-05bacac2e323',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'b92ac7a6-5025-42fa-921a-05bacac2e323'
      const wordName = '期末持仓分析.pdf'
