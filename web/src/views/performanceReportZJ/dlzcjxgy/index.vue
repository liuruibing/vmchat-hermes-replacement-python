...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportDLZCJXGY',
      id: 'J_iframe_id_reportDLZCJXGY',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '58877543-2ff6-4f47-8f11-9a8755f93ed7',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '58877543-2ff6-4f47-8f11-9a8755f93ed7'
      const wordName = '大类资产绩效归因.pdf'
