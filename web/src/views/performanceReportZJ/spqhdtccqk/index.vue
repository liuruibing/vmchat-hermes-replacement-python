...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportSPQHDTCCQK',
      id: 'J_iframe_id_reportSPQHDTCCQK',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'a5d04cbe-f9e2-4129-a58c-e731ede456b0',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'a5d04cbe-f9e2-4129-a58c-e731ede456b0'
      const wordName = '商品期货动态持仓情况.pdf'
