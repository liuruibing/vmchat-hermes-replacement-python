...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportGMZL',
      id: 'J_iframe_id_reportGMZL',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '67f586d0-7eb0-480f-a8d4-624861c240e8',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '67f586d0-7eb0-480f-a8d4-624861c240e8'
      const wordName = '规模总览.pdf'
