<template>
  <div style="height: 100%" class="PerformanceReportStyle">
    <el-container style="height: 100%">
      <!--板块组合分析-->
      <el-main style="height: 100%; overflow-x: hidden; overflow-y: hidden; padding-left: 0.5% !important; padding-right: 0.5% !important">
          ...
          <el-row>
            <el-col :span="24">
              <div class="grid-content bg-purple">
                ...
                <el-form-item class="">
                  <el-button icon="el-icon-search" style="margin-bottom: 5px" size="small" type="primary" @click="onSubmit('formInline')">查询</el-button>
                  <el-button plain type="info" icon="el-icon-refresh-left" size="small" @click="resetForm('formInline')">重置</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportCAMPISI',
      id: 'J_iframe_id_reportCAMPISI',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'd6366ab9-507c-4ec8-bd9b-9a77d2bf771d',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'd6366ab9-507c-4ec8-bd9b-9a77d2bf771d'
      const wordName = 'Campisi归因.pdf'
