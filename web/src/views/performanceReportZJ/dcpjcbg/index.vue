...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportDCPJCBG',
      id: 'J_iframe_id_reportDCPJCBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '18ba1ffc-c85d-4ff0-966d-c1da2bf7ae1e',
          self.formInline.beginDate,
          self.formInline.endDate,
          self.formInline.fundCode,
    ...
    fun_export_PDF() {
      ...
      const templateCode = '18ba1ffc-c85d-4ff0-966d-c1da2bf7ae1e'
      const wordName = '多产品-基础指标报告.pdf'
