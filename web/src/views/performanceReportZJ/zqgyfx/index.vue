...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportZQGYFX',
      id: 'J_iframe_id_reportZQGYFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '3063b8f9-b083-4704-9ce2-26a045fec003',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '3063b8f9-b083-4704-9ce2-26a045fec003'
      const wordName = '债券归因分析.pdf'
