...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportSYFX',
      id: 'J_iframe_id_reportSYFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '5b4d778a-34c0-4d56-a9af-cdbd33eb97b7',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '5b4d778a-34c0-4d56-a9af-cdbd33eb97b7'
      const wordName = '收益分析.pdf'
