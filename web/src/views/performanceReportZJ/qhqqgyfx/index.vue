...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportQHQQGYFX',
      id: 'J_iframe_id_reportQHQQGYFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '704cde52-38a1-4df0-8802-a356b4ddd696',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '704cde52-38a1-4df0-8802-a356b4ddd696'
      const wordName = '期货期权归因分析.pdf'
