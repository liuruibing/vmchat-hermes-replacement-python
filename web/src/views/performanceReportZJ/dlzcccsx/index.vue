...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportDLZCCCSX',
      id: 'J_iframe_id_reportDLZCCCSX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '9c459c6c-1b5f-4fee-9415-edf22c3f3128',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '9c459c6c-1b5f-4fee-9415-edf22c3f3128'
      const wordName = '大类资产持仓时序.pdf'
