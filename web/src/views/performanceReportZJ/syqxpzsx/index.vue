...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportSYQXPZSX',
      id: 'J_iframe_id_reportSYQXPZSX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'ec03be70-ac73-469f-8adc-cefc8189f289',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'ec03be70-ac73-469f-8adc-cefc8189f289'
      const wordName = '剩余期限配置时序.pdf'
