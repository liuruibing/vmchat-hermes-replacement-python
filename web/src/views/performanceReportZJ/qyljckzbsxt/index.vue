...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportQYLJCKZBSXT',
      id: 'J_iframe_id_reportQYLJCKZBSXT',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '32b1fa71-e7e9-40ff-b229-dfe61e998e82',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '32b1fa71-e7e9-40ff-b229-dfe61e998e82'
      const wordName = '权益类净敞口占比时序图.pdf'
