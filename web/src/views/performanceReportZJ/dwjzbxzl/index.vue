...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportDWJZBXZL',
      id: 'J_iframe_id_reportDWJZBXZL',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'f811fa7e-1cee-48d4-b43f-fd7366c92925',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'f811fa7e-1cee-48d4-b43f-fd7366c92925'
      const wordName = '单位净值表现总览.pdf'
