...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportTSZBBG',
      id: 'J_iframe_id_reportTSZBBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      onButton:false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '341f6211-31be-4216-99f2-5a36ae2cb112',
          self.formInline.beginDate,
          self.formInline.endDate,
    ...
    fun_export_PDF() {
      ...
      const templateCode = '341f6211-31be-4216-99f2-5a36ae2cb112'
      const wordName = '特色指标报告.pdf'
