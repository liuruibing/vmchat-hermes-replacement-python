...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportCGHYFX',
      id: 'J_iframe_id_reportCGHYFX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '4256614b-8e45-4895-929d-53aeaccae57a',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '4256614b-8e45-4895-929d-53aeaccae57a'
      const wordName = '持股行业分析.pdf'
