...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportZJQQLJX',
      id: 'J_iframe_id_reportZJQQLJX',
      baseApi: '', // 页面根地址
      exportButton: false,
      onButton:false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/qqljxbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '743bae15-9d26-4cfe-bd51-a6afdc9b10a4',
          self.formInline.beginDate,
          self.formInline.endDate,
    ...
    fun_export_PDF() {
      ...
      const templateCode = '743bae15-9d26-4cfe-bd51-a6afdc9b10a4'
      const wordName = '期权类绩效报告.pdf'
      // fun.fun_exportwordrisk(wordName);
