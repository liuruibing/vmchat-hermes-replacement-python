...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportZJHHCL',
      id: 'J_iframe_id_reportZJHHCL',
      baseApi: '', // 页面根地址
      exportButton: false,
      onButton:false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/hhclbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'a8f965dc-454c-4639-bbf7-13377a2cec9c',
          self.formInline.beginDate,
          self.formInline.endDate,
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'a8f965dc-454c-4639-bbf7-13377a2cec9c'
      const wordName = '混合策略报告.pdf'
