...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportZHJQBDSX',
      id: 'J_iframe_id_reportZHJQBDSX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'cd9f67e9-6a15-4586-81bf-ed31044e1c51',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'cd9f67e9-6a15-4586-81bf-ed31044e1c51'
      const wordName = '组合久期变动时序.pdf'
