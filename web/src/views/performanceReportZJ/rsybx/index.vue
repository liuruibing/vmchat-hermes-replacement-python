...
export default {
  ...
  data() {
    ...
    return {
      ...
      //成立日
      timDate: '',
      name: 'iframeVue_reportRSYBX',
      id: 'J_iframe_id_reportRSYBX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'fa347632-6660-478f-8a25-ecff19d38cc8',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'fa347632-6660-478f-8a25-ecff19d38cc8'
      const wordName = '日收益表现.pdf'
