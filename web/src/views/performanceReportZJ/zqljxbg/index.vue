...
export default {
  ...
  data() {
    ...
    return {
      ...
      formInline: {
        ...
        ZB_INDEXCODEA: 'H11001', // 基准A
        ZB_INDEXWEIGHTA: '0.0000', // 基准A权重
        ZB_INDEXCODEB: 'H11001', // 基准B
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportZJZQJX',
      id: 'J_iframe_id_reportZJZQJX',
      baseApi: '', // 页面根地址
      exportButton: false,
      onButton:false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/zqjxbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'adf67c39-ce14-4e1e-ab2d-3feb967b4421',
          self.formInline.beginDate,
          self.formInline.endDate,
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'adf67c39-ce14-4e1e-ab2d-3feb967b4421'
      const wordName = '债券类绩效报告.pdf'
