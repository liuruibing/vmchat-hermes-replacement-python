    ...
    <div class="productLevelInfo" v-if="showLevelInfo">
      ...
      <div class="product-info-content" v-loading="baseLevelLoading">
        ...
        <div class="row-body" v-for="item in productLevelData" :key="item.id">
          ...
          <div class="col">
            <el-rate value="3" :colors="['#0F65DD', '#0F65DD', '#0F65DD']" disabled disabled-void-color="#ccc"></el-rate>
          </div>
          <div class="col">
            <el-rate v-model="item.earnLevel" :colors="['#0F65DD', '#e03d3e', '#e03d3e']" disabled disabled-void-color="#ccc"></el-rate>
          </div>
...
export default {
  ...
  methods: {
    ...
    queryAuthIndex() {
      const params = {}
      params.templateCode = '3a1097da-2a09-4ff4-987c-e13c5b6907a9'
