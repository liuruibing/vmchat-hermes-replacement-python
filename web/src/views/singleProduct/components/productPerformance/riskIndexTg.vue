<template>
  <div class="riskIndex">
    <div v-show="showFXZB">
      ...
      <div>
        <span style="color:#ff0000;padding-left: 30px;">数据截止：{{IndustryDataUpDate3}}</span>
      </div>
        ...
        <el-row>
          ...
          <el-col :span="12">
            ...
            <div id="standard-table">
              <vxe-table show-header-overflow show-overflow auto-resize :row-config="{ isHover: true }" :data="tableData1" stripe>
  ...
  methods: {
    async fun_iframeSrc() {
      ...
      if (this.showFXZB) {
        ...
        this.getFxzbDataDate()
      }
      //获取排名数据
      if (this.showPM) {
        this.getDialData_tg('cc4fbfe3-7ad9-41dc-9bb9-24c97fb32cc9')
      }
      // 获取动态回撤的echarts数据
      if (this.showDTHC) {
      ...
      return new Promise((resolve, reject) => {
        ...
        commonAPI
          ...
          .then((res) => {
            let { status, data } = res.data
            if (status == 0) {
              this.IndustryDataUpDate3 = data[0].d_maxdate
            } else {
              this.IndustryDataUpDate3 = ''
            }
          })
        ...
        commonAPI
          ...
          .then((res) => {
            ...
            if (status === 0) {
              ...
              if (this.canShowIndexArr.includes('4da54c8a-db9f-420b-a05d-162912ebdd5e')) {
                this.showPM = true
              } else {
                this.showPM = false
              }
        ...
        commonAPI
          ...
          .then((res) => {
            ...
            if (status == 0) {
              ...
              this.radio = 1
              if (data.length) {
                this.rankingDate = data[0].YDATE1
