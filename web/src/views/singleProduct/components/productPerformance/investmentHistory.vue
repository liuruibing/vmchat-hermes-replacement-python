<template>
  <div class="investment-history-tg standard-form">
    <div v-if="indexInfoArray.indexOf('3864e859-1579-41dd-a99f-ad1f89e11287') !== -1" class="titleBox">
      <div class="title_name">
        <div class="title_name_icon"></div>
        <span>历史收益走势图</span>
        <el-button style="float: right; margin-left: 15px" type="info" size="small" plain @click="exportChartToTable">导出excel</el-button>
    ...
    <el-row v-if="indexInfoArray.indexOf('3864e859-1579-41dd-a99f-ad1f89e11287') !== -1">
      ...
      <el-col :span="10" style="margin-right: 20px">
        <div class="chart-content">
          ...
          <div id="standard-table">
            <vxe-table :data="tableData"  auto-resize border show-header-overflow show-overflow stripe>
              ...
              <vxe-table-column align="right" header-align="center" title="复权累计净值">
                <template slot-scope="scope">
                  <span>{{ scope.row.f4 | numberToFixed(4, 1) }}</span>
                </template>
              </vxe-table-column>
    ...
    <div v-if="indexInfoArray.indexOf('b5a9ae1e-54c7-4f60-8ac1-fdc408ab7fad') !== -1" class="titleBox">
      <el-row type="flex">
        <el-col :span="4">
    ...
    <div id="standard-table">
      <vxe-table
        v-if="indexInfoArray.indexOf('b5a9ae1e-54c7-4f60-8ac1-fdc408ab7fad') !== -1"
        :data="tableData2"
    ...
    <el-row v-if="indexInfoArray.indexOf('b5a9ae1e-54c7-4f60-8ac1-fdc408ab7fad') !== -1">
      <el-col :span="14">
        <div class="chart-content">
    ...
    <div v-if="indexInfoArray.indexOf('2dda5fd4-7d76-42fc-b50c-2e9d6fd4ebd8') !== -1" class="titleBox">
      <div class="title_name">
        <div class="title_name_icon"></div>
        <span>历史净值</span>
        <el-button size="small" type="info" plain style="float: right" @click="exportToExcel">导出excel</el-button>
      </div>
    </div>
    <vxe-table
      v-if="indexInfoArray.indexOf('2dda5fd4-7d76-42fc-b50c-2e9d6fd4ebd8') !== -1"
      :data="tableData4"
    ...
    >
      ...
      <vxe-table-column align="center" header-align="center" min-width="130px" title="复权累计单位净值">
        <template slot-scope="scope">
          <span>{{ scope.row.f5 | numberToFixed(4, 1) }}</span>
        </template>
      </vxe-table-column>
...
export default {
  ...
  methods: {
    ...
    async queryHistoryEarn(val) {
      ...
      // 如果 历史收益走势图编码存在则查询
      if (this.indexInfoArray.indexOf('3864e859-1579-41dd-a99f-ad1f89e11287') !== -1) {
    ...
    async fun_iframeSrc() {
      ...
      // 查询 业绩分析 上表格
      if (this.indexInfoArray.indexOf('b5a9ae1e-54c7-4f60-8ac1-fdc408ab7fad') !== -1) {
        this.getIndustryDataUp()
        this.getIndustryDataDown()
      }

      // 查询历史净值
      if (this.indexInfoArray.indexOf('2dda5fd4-7d76-42fc-b50c-2e9d6fd4ebd8') !== -1) {
        this.getHistoryUnit()
      }
    ...
    getInvestMentHistoryData(val) {
      const params = {}
      params.rate = val ? val : ''
      params.indexCode = '6df0cdac-3354-4d04-a282-88cc1072abb6'
      params.startDate = this.searchQuery.startDate
      params.endDate = this.searchQuery.endDate
      params.fundCode = this.searchQuery.fundCode
      params.kpiCode = this.searchQuery.kpiCode
    ...
    handleEchartsData(data) {
      ...
      for (let i = this.echartData.length - 1; i >= 0; i++) {
        ...
        for (let j = temp.origin.length - 1; j >= 0; j--) {
          ...
          if (stemp.YDATA2 || stemp.YDATA5 || stemp.YDATA4) {
    ...
    getIndustryDataDown() {
      const params = {}
      params.indexCode = '440b6ad6-0cce-46d4-b117-05eee752119e'
      params.startDate = this.searchQuery.startDate
      params.endDate = this.searchQuery.endDate
      params.fundCode = this.searchQuery.fundCode
      params.kpiCode = this.searchQuery.kpiCode
