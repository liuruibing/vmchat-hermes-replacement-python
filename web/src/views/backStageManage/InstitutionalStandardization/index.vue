<template>
  <div class="standardization analyse-page" v-auto-enter>
    <div class="standard-form-margin">
      <div class="inner-margin">
        <el-form :inline="true" :model="formQuery" ref="formQuery" :rules="searchRules" label-width="120px;" class="standard-form">
          <el-form-item label="" prop="fundName">
            <el-input v-model="formQuery.fundName" placeholder="请输入机构/产品名称" style="width: 175px !important;" size="small"></el-input>
          </el-form-item>
          ...
          <el-form-item label="" prop="beginDate">
            <el-date-picker v-model="formQuery.beginDate" type="date" size="small" value-format="yyyy-MM-dd" placeholder="申请开始日期"></el-date-picker>
          </el-form-item>
          <span style="line-height: 32px; padding-right: 5px;color:#fff">-</span>
          <el-form-item label="" prop="endDate">
            <el-date-picker v-model="formQuery.endDate" type="date" size="small" value-format="yyyy-MM-dd" placeholder="申请结束日期"></el-date-picker>
          </el-form-item>
    ...
    <div class="table-content" id="standard-table">
      <div id="standard-table-margin">
        ...
        >
          ...
          <vxe-table-column label="操作" width="300px" align="center">
            <template slot-scope="scope">
              <span class="operate-btn table-operation">
                <el-button type="info" plain size="small" @click="handleDemandRow(scope.row)">处理</el-button>
                <el-button size="small" plain type="info" @click="handleOpenDetail(scope.row)">详情</el-button>
...
export default {
  ...
  computed: {
    isShowCheckBox() {
      console.log('调试')
      console.log(this.$store.state.btnData.includes('demandAllot'))
