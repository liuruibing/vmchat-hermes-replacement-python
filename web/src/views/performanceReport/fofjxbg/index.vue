        ...
        <div class="search-content" style="margin-top: 12px;margin-bottom: 30px">
          <el-form ref="formInline" :inline="true" :model="formInline" :rules="searchRules" class="demo-form-inline form_inline_search" style="margin-top: 10px">
            <el-row>
              ...
              <el-form-item>
                <el-button icon="el-icon-search" style="margin-bottom: 5px" size="small" type="primary" @click="onSubmit('formInline')">
                  查询
                </el-button>
                <el-button icon="el-icon-refresh-left" plain type="info" size="small" @click="resetForm('formInline')">
                  重置
                </el-button>
              </el-form-item>
              <el-form-item>
              ...
              <el-form-item class="search_button_com">
                <el-button type="info" style="margin-bottom: 5px" :disabled="exportButton2" @click="fun_export_PDF" size="small">
                  {{ exportText2 }}
                </el-button>
              </el-form-item>
            </el-row>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      name: 'iframeVue_reportFOFCTBG',
      id: 'J_iframe_id_reportFOFCTBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'ecd5d15e-1120-4443-a93b-7f3313d182be',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'ecd5d15e-1120-4443-a93b-7f3313d182be'
      const wordName = 'FOF绩效报告.docx'
