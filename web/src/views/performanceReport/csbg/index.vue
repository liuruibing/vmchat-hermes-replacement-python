...
export default {
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '854c5fc0-79e5-40a9-af12-37388288c521',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '854c5fc0-79e5-40a9-af12-37388288c521'
      const wordName = '测试报告.docx'
    ...
    fun_export() {
      ...
      if (self.fundCode == '') {
        ...
        fun.file_vmrisk_download(
          ...
          'bf14c05e-d8e9-4b93-a3ae-41bdcfcb93b1',
          self.formInline.beginDate,
          self.formInline.endDate,
          self.fundCode,
          '',
