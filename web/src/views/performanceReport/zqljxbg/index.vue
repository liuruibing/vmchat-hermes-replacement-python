          ...
          <el-form ref="formInline" :inline="true" :model="formInline" :rules="searchRules" class="demo-form-inline form_inline_search" style="margin-top: 10px">
            <el-row>
              ...
              <el-form-item>
                ...
                <el-button type="info" size="small" @click="resetForm('formInline')">
                  重置
                </el-button>
              </el-form-item>
              <el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      name: 'iframeVue_reportZQLJXBG',
      id: 'J_iframe_id_reportZQLJXBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '75788b68-46b5-4a02-9b8a-1facc0e4fdb8',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '75788b68-46b5-4a02-9b8a-1facc0e4fdb8'
      const wordName = '债券类绩效报告.docx'
