        ...
        <div class="search-content" style="margin-top: 12px;margin-bottom: 30px">
          <el-form ref="formInline" :inline="true" :model="formInline" :rules="searchRules" class="demo-form-inline form_inline_search" style="margin-top: 10px">
            <el-row>
              ...
              <el-form-item>
                <div style="color: red;">拥有此产品：{{ fundGrant }}权限，报告仅显示有权限模块，报告显示结束日期所在月份的月底数据。</div>
              </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      name: 'iframeVue_reportJXJB',
      id: 'J_iframe_id_reportJXJB',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          'fa01ef08-3a1c-426c-b3ec-9ff0307a840a',
    ...
    fun_export_PDF() {
      ...
      const templateCode = 'fa01ef08-3a1c-426c-b3ec-9ff0307a840a'
      const wordName = '绩效简报.docx'
