        ...
        <div class="search-content" style="margin-top: 12px;margin-bottom: 30px">
          <el-form ref="formInline" :inline="true" :model="formInline" :rules="searchRules" class="demo-form-inline form_inline_search" style="margin-top: 10px">
            <el-row>
              ...
              <el-form-item>
                <el-button size="small" type="primary" icon="el-icon-search" @click="onSubmit('formInline')">
                  查询
                </el-button>
                <el-button type="info" size="small" plain icon="el-icon-refresh-left" @click="resetForm('formInline')">
                  重置
                </el-button>
              </el-form-item>
              <el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      name: 'iframeVue_reportQYLJX',
      id: 'J_iframe_id_reportQYLJX',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  methods: {
    ...
    fun_iframeSrc() {
      ...
      try {
        self.iframeData.src = this.file_vmrisk_src(
          ...
          '7e3eb541-89d4-4276-ba1f-2c85a1b1d480',
    ...
    fun_export_PDF() {
      ...
      const templateCode = '7e3eb541-89d4-4276-ba1f-2c85a1b1d480'
      const wordName = '权益类绩效报告.docx'
