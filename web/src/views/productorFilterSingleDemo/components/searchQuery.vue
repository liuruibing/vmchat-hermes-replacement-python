...
<!--                <el-form-item class="searchRight">
                ...
                <el-form-item>
                  ...
                  <el-button :disabled="exportDisabled" size="small" type="info" plain icon="el-icon-download" @click="$emit('excelexport')">
                    导出Excel
                  </el-button>
                </el-form-item>
              </el-row>
...
export default {
  ...
  mounted() {
    this.simpleSearch.endDate = '2026-08-14'
  ...
  methods: {
    ...
    removeCondition(tag) {
      if (this.$refs.epibolyQuery) {
        this.$refs.epibolyQuery.handleClose(tag)
      }
    },
    /**
    ...
    reset() {
      ...
      this.$emit('grandChildObj', [], 'grandChild')
      this.$emit('resetPage')
      this.$nextTick(() => this.handleQueryParams())
    },
    /**
