...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_CCDLBG',
      id: 'J_iframe_id_reportGF_CCDLBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/ccdlbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            '36569BF56710B933E063229C500A840C',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  '36569BF56710B933E063229C500A840C'
      const pdfName = '持仓大类报告.pdf'
