...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_GQZBBG',
      id: 'J_iframe_id_reportGF_GQZBBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/gqzbbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            '365654107698D49AE063229C500AFD78',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  '365654107698D49AE063229C500AFD78'
      const pdfName = '个券指标报告.pdf'
