...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_TGMJJ',
      id: 'J_iframe_id_reportGF_TGMJJ',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/tgmjj' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            '25C318C4A8D5449DE063CA0113AC3FB5',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  '25C318C4A8D5449DE063CA0113AC3FB5'
      const pdfName = '投顾母基金.pdf'
