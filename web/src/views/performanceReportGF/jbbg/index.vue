...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_JBBG',
      id: 'J_iframe_id_reportGF_JBBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/jbbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            'D06956491B986957E053CA0113AC00CC',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  'D06956491B986957E053CA0113AC00CC'
      const pdfName = '日频净值报告.pdf'
