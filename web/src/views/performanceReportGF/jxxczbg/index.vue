...
export default {
  ...
  data() {
    ...
    return {
      ...
      noData: '--', // 没有数据
      // 报告Tab相关配置，保持重叠显示
      activeTab: 'simple_gfxc', // 默认选中简版报告
      reportTemplateList:[],
      reportTabs: [],
      //成立日
      timDate: '',
  ...
  methods: {
    ...
    initReportTemplateList() {
      return new Promise((resolve, reject) => {
        const params = {
          indexCode: 'b450d3a0-4d49-9365-5f57-763ad263d868'
        }
        request({
          url: `/api/report/v1.0/data/sql/b450d3a0-4d49-9365-5f57-763ad263d868`,
          method: 'post',
          data: params
        })
          .then((res) => {
