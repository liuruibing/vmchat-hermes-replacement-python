...
export default {
  ...
  data() {
    ...
    return {
      ...
      formInline: {
        ...
        dataFreq:'2',//数据频率  1 日频 2 周频  3 月频
      },
      dataFreqOptionList: [],
      ZB_INDEXTYPEOption: [
        {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_JBBGWEEK',
      id: 'J_iframe_id_reportGF_JBBGWEEK',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/jbbgweek' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            '38cc1063-7d44-41c2-a60a-a137e74dc12f',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  '38cc1063-7d44-41c2-a60a-a137e74dc12f'
      const pdfName = '周频净值报告.pdf'
