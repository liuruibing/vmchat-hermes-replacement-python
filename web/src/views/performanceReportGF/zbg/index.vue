...
export default {
  ...
  data() {
    ...
    return {
      ...
      noData: '--', // 没有数据
      // 报告Tab相关配置，保持重叠显示
      activeTab: 'simple', // 默认选中简版报告
      reportTemplateList:[],
      reportTabs: [
        // {
        //   id: 'simple',
        //   name: '简版报告',
        //   templateCode: 'D06956491B986957E053CA0113AC00CC',
        //   iframeId: 'J_iframe_id_report_simple',
        //   iframeName: 'iframeVue_report_simple',
        //   iframeData: { src: '' },
        ...
        //   id: 'standard',
        //   name: '标准报告',
        //   templateCode: 'D06956491B976957E053CA0113AC00CC',
        ...
        //   id: 'stock',
        //   name: '股票多头',
        //   templateCode: 'D06956491B996957E053CA0113AC00CC',
        //   iframeId: 'J_iframe_id_report_stock',
        //   iframeName: 'iframeVue_report_stock',
        //   iframeData: { src: '' },
        //   scrollPosition: 0,
        //   needsScrollRestore: false,
        //   queryParams: null,
        ...
        //   id: 'bond',
        //   name: '债券基金',
        //   templateCode: 'D06956491B9A6957E053CA0113AC00CC',
        ...
        //   id: 'futures',
        //   name: '管理期货',
        //   templateCode: 'D06956491B9B6957E053CA0113AC00CC',
        //   iframeId: 'J_iframe_id_report_futures',
        //   iframeName: 'iframeVue_report_futures',
        //   iframeData: { src: '' },
        //   scrollPosition: 0,
        //   needsScrollRestore: false,
        //   queryParams: null,
        ...
        //   id: 'advisor',
        //   name: '投顾母基金',
        //   templateCode: '25C318C4A8D5449DE063CA0113AC3FB5',
        //   iframeId: 'J_iframe_id_report_advisor',
        //   iframeName: 'iframeVue_report_advisor',
        //   iframeData: { src: '' },
        //   scrollPosition: 0,
        //   needsScrollRestore: false,
        //   queryParams: null,
        ...
        //   id: 'fof',
        //   name: 'FOF类报告',
        //   templateCode: '82b18752-2367-4083-8fb8-02d3126c023d',
        //   iframeId: 'J_iframe_id_report_fof',
        //   iframeName: 'iframeVue_report_fof',
        //   iframeData: { src: '' },
        //   scrollPosition: 0,
        //   needsScrollRestore: false,
        //   queryParams: null,
        ...
        //   id: 'fof_penetrate',
        //   name: 'FOF类报告-穿透',
        //   templateCode: 'ecd5d15e-1120-4443-a93b-7f3313d182be',
        //   iframeId: 'J_iframe_id_report_fof_penetrate',
        //   iframeName: 'iframeVue_report_fof_penetrate',
        //   iframeData: { src: '' },
        //   scrollPosition: 0,
        //   needsScrollRestore: false,
        //   queryParams: null,
  ...
  methods: {
    ...
    initReportTemplateList() {
      return new Promise((resolve, reject) => {
        const params = {
          indexCode: '7f10609a-fc6e-4369-82fe-d500121a8324'
        }
        request({
          url: `/api/report/v1.0/data/sql/7f10609a-fc6e-4369-82fe-d500121a8324`,
          method: 'post',
          data: params
        })
          .then((res) => {
    ...
    updateCurrentReportIframe() {
      ...
      // 处理特殊参数
      if (this.formInline.ZB_INDEXTYPE == 'djz') {
    ...
    file_vmrisk_src_view(templateCode, beginDate, endDate, fundCode, benchmarkA, benchmarkB, benchmarkAValue, benchmarkBValue, kpiCode, contrasCode, desensitizationFlag, desensitizationFun,dataFreqOpen,dataFreq) {
      return (
        process.env.BASE_API +
        '/rest/report/interview.do?templateCode=' +
        templateCode +
