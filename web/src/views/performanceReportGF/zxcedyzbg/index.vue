...
export default {
  ...
  data() {
    ...
    return {
      ...
      //开关
      offOn: false,
      name: 'iframeVue_reportGF_ZXCEDYZBG',
      id: 'J_iframe_id_reportGF_ZXCEDYZBG',
      baseApi: '', // 页面根地址
      exportButton: false,
      exportText: '导出',
  ...
  watch: {
    '$route.path'(val) {
      if (val == '/jxbg/zxcedyzbg' && this.$store.getters.isHome === true) {
  ...
  methods: {
      ...
      try {
        if (this.reportType == 'preview') {
          self.iframeData.src = this.file_vmrisk_src_preview(
            ...
            '4f4edc73-7559-4325-ae82-f2074d729ed3',
    ...
    fun_export_PDF() {
      ...
      const templateCode =  '4f4edc73-7559-4325-ae82-f2074d729ed3'
      const pdfName = '中性策略-多因子-分析报告.pdf'
