...
export default {
  ...
  methods: {
    ...
    file_vmrisk_src_preview(templateCode, beginDate, endDate, fundCode, benchmarkA, benchmarkB, benchmarkAValue, benchmarkBValue, kpiCode, contrasCode,desensitizationFlag,desensitizationFun,dataFreqOpen,dataFreq) {
      return (
        process.env.BASE_API +
