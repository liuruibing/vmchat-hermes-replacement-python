          ...
          <el-row>
            <el-form ref="searchForm" :inline="true" :model="simpleSearch" :rules="rules" class="standard-form">
              <el-row type="flex" justify="start">
                <el-form-item label="">
                  <el-input v-model="simpleSearch.manager_name" placeholder="管理人名称/拼音首字母/备案编码" size="small" style="width: 240px !important;" />
                </el-form-item>
                ...
                <el-form-item label="" prop="endDate">
                  <el-date-picker :clearable="false" v-model="simpleSearch.endDate" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" size="small" />
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" size="small" @click="handleQueryParams" icon="el-icon-search">
                    查询
                  </el-button>
