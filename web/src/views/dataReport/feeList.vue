  ...
  <div>
        ...
        <el-col :span="16">
          <div style="width:100%;">
            ...
            <el-form-item label="产品信息" prop="fundCode">
             ...
             <el-form-item label="费用日期" prop="beginDate">
                <el-date-picker
              ...
              <span style="color:red"> 注:数据更新到T-2日</span>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
   ...
   <div class="forms_table_title">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.YFSHF | noDataFilter }}</span>
        </template>
       </el-table-column>
        <el-table-column
        prop="YFYJBC"
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.YFYJBC | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.YFGLF | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.YFTGF | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.YFYYF | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.SFHJ | noDataFilter }}</span>
        </template>
      </el-table-column>
       ...
       <el-table-column
           ...
           >
          <template slot-scope="scope">
              <el-button  plain type="text" size="mini"  @click="serachDetail(scope.row)">历史查询</el-button>
          </template>
     </el-table-column>
   ...
   methods: {
    ...
    Pagination(val) {
     ...
     onSubmit(formName,flag){
        ...
        params.generalName = 'product.queryData.fundCosts';
     ...
     serachDetail(row){
       ...
       this.$router.push({path:'/newReport/feeHistoryList',query: {fundCode:row.FUNDCODE}})
     }
