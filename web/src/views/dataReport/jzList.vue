        ...
        <el-col :span="16">
          <div style="width:100%;">
            ...
            <el-form-item label="产品信息" prop="fundCode">
             ...
             <el-form-item label="" prop="liquidated">
               <el-checkbox v-model="formInline.liquidated">过滤已清盘产品</el-checkbox>
            </el-form-item>
    ...
    Pagination(val) {
     ...
     onSubmit(formName,flag){
        ...
        if(params.liquidated){
          params.liquidated = '已清盘';
        }
        params.pageable = true;
        params.generalName = 'product.queryData.valuation';
     ...
     serachDetail(row){
       ...
       this.$router.push({path:'/newReport/jzHistoryList',query: {fundCode:row.FUNDCODE,parentFundCode:row.PARENTFUNDCODE}})
     }
