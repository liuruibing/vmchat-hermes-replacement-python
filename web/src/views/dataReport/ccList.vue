        ...
        <el-col :span="16">
          <div style="width:100%;">
            ...
            <el-form-item label="产品信息" prop="fundCode">
             ...
             <el-form-item label="持仓日期" prop="beginDate">
                <el-date-picker
   ...
   methods: {
    ...
    Pagination(val) {
     ...
     onSubmit(formName,flag){
        ...
        params.generalName = 'product.queryData.fundPosition';
     ...
     serachDetail(row){
       ...
       this.$router.push({path:'/newReport/ccHistoryList',query: {fundCode:row.FUNDCODE}})
     }
