    ...
    <div  style="">
      <div class="forms_table_title" style="float: left">
        ...
        <span style="margin-left:20px">
            ...
            <!-- <el-button type="primary" plain @click="print('pdf')" style="margin-bottom: 5px; " size="small">
              <i class="el-icon-printer"></i>打印
            </el-button>
            <el-button  type="primary" plain @click="mailmail()" style="margin-bottom: 5px; " size="small">
              <i class="el-icon-message"></i>快捷邮件发送
            </el-button>
            <el-button  type="primary" plain @click="customMail()" style="margin-bottom: 5px; " size="small">
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                type="primary"
                size="small"
                @click="downloadRowData(scope.row, false)"
                >生成台账</el-button
              >
              <el-button
...
export default {
  ...
  components: { Pagination,mySelf,sendMailForm },
  props: {
  ...
  methods: {
    ...
    resetForm(){
      ...
      // this.$nextTick(()=>{
        this.searchDataArr.forEach(item=>{
          if(item.inputType=='select_multiple'){
    ...
    downloadRowData(row){
      let oo = JSON.parse(JSON.stringify(row));
      let params = oo;
      params.type = 'excel';
      params.reportCode = this.reportCode;
      params.tableCode = this.activeName;
      let obj = {
        mapType:JSON.stringify(params),
        token:this.$store.getters.token
      }
