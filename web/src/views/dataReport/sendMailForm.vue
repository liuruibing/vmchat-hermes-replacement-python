<template>
  <div class="send_mail_form">
            ...
            <el-option
              ...
              @click.native="
                item.sonEn
                  ...
                  : getSunClick(group.DIM_CDE, group.DIM_NME, item.fieldEn)
              "
            >
            </el-option>
          </el-select>
    ...
    <div style="width: 90%; margin: 0 auto">
      ...
      >
        ...
        <el-form-item label="收件人" prop="emailTos">
          <selectContacts
            ref="selectContacts"
            v-model="formData.emailTos"
          ></selectContacts>
        </el-form-item>
        <el-form-item label="抄送" prop="emailCcs">
          <selectContacts
            ref="selectContacts2"
            v-model="formData.emailCcs"
          ></selectContacts>
        </el-form-item>
        <el-form-item label="密送" prop="emailBccs">
          <selectContacts
            ref="selectContacts3"
            v-model="formData.emailBccs"
          ></selectContacts>
        </el-form-item>
        <div class="hebing">
    ...
    <div style="text-align: center">
      ...
      <el-button type="primary" @click="submitFormValid" :loading="send_loading"
        >发送</el-button
      >
    </div>
  </div>
