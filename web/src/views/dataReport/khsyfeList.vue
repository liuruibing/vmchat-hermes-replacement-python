<template>
  <div>
        ...
        <el-col :span="21">
          <div style="width:100%;">
            ...
            <el-form-item label="产品信息" prop="fundCode">
             ...
             <el-form-item label="净值日期" prop="beginDate">
                <el-date-picker
   ...
   <div class="forms_table_title">
      <i class="el-icon-s-data"></i>客户剩余份额申购时间查询(TA确认数据)
    </div>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.KHMC | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.KHLX | noDataFilter }}</span>
        </template>
       </el-table-column>
        <el-table-column
        prop="ZJLX"
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.ZJLX | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.ZJHM | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.JZRQ | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.SQRQ | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.QRRQ | noDataFilter }}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.SHAREBAL | noDataFilter }}</span>
        </template>
      </el-table-column>
   ...
   methods: {
    ...
    Pagination(val) {
     ...
     onSubmit(formName,flag){
        ...
        params.generalName = 'product.queryData.restShare';
