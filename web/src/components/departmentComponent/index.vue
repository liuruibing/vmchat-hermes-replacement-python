  ...
  <div>
    <el-dialog :append-to-body="true" :visible.sync="dialogVisible" style="padding: 0px 20px" width="80%" @closed="handleDialogClosed">
      <el-row>
        <el-col :span="20">
          <el-form ref="formQuery" :model="formQuery" class="standard-form" :rules="formRules" inline>
            <el-form-item label="" prop="userInput">
              <el-input v-model="formQuery.userInput" placeholder="管理人全称/拼音/备案号" style="width: 230px !important" size="small"></el-input>
            </el-form-item>
        ...
        <el-col :span="4">
          <div class="search_button_com standard-form">
      ...
      <div slot="footer" style="text-align: center" class="standard-form">
