<template>
  ...
  <el-aside :width="boxWidth" class="ProductAndProperty_box" >
    <div style="height: 100%;">
      <div :class="ProductAndPropertyData.productClass"  style="width: 233px;">
        ...
        >
              <span class="el-tree-node__label" slot-scope="{ node, data }" >
                <el-tooltip effect="dark" :content="node.label" placement="right"   >
                  <span style="width: 150px;display: inline-block;overflow: hidden;">{{ node.label }}</span>
                </el-tooltip>
              </span>
        </el-tree>
      </div>
      ...
      <div class="flex_center left_right_button" @click="ProductAndProperty_left_right">
        <i :class="left_right_button_icon"></i>
      </div>
    </div>
  </el-aside>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      ProductAndProperty_left_right(){
        ...
        // 隐藏打开事件
        this.$emit('asideOpen', switchOpen)
      }
