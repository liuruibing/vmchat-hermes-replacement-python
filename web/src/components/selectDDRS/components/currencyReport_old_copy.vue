<template>
  <div class="currency_report_old_copy vxe_custom_style">
    <el-tabs v-model="activeName" v-if="tabArr.length > 1" @tab-click="handleClick">
      <el-tab-pane v-for="item in tabArr" :key="item.tableCode" :label="item.tableCn" :name="item.tableCode"> </el-tab-pane>
    </el-tabs>
    ...
    <el-dialog title="明细" append-to-body center :visible.sync="detailDialog" width="80% !important" :close-on-click-modal="false">
