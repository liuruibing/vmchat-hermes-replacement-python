-- ================================================================================
-- 银河项目 全部 36 个 VM 模块真实数仓 SQL 查询脚本集合 (OceanBase Oracle 模式)
-- 包括各业务模块在数仓中的原生计算语句、输入入参规范与字段输出定义
-- 可直接在 DBX / DBeaver / Navicat 中选中任意段落执行
-- ================================================================================

-- --------------------------------------------------------------------------------
-- 【模块 01】: 大类资产收益贡献 (assetContribute)
-- 对应执行契约 sqlCode: 4c15f9fd-98c1-4280-b7bb-56893691279a
-- 业务分类: 收益与归因
-- 核心底层数仓表: MFACTGZ_FUND_ASSET_INCOME_FEE, MFACTGZ_FUND_HLDTOTAL, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 02】: 持仓平均PE/PB时序 (averagePePb)
-- 对应执行契约 sqlCode: cf8b548d-50d3-4a92-bde5-784bf707733f
-- 业务分类: 估值与特征
-- 核心底层数仓表: MFACTGZ_STOCK_VALUATION, MFACTGZ_FUND_HLDDETAIL, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 03】: 债券持仓集中度 (bondConcentrate)
-- 对应执行契约 sqlCode: ec66b44b-5e8b-4057-8046-79dd6798eee7
-- 业务分类: 债券与固收
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MFACTGZ_FUND_HLDTOTAL, MDIM_BOND_INFO
...
-- --------------------------------------------------------------------------------
-- 【模块 04】: 债券久期变动时序 (bondDurationTiming)
-- 对应执行契约 sqlCode: 2010a50e-3f6a-478c-8dc2-796df2799f10
-- 业务分类: 债券与固收
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_BOND_INFO, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 05】: Campisi债券绩效归因 (campisiBondAnal)
-- 对应执行契约 sqlCode: 95b8781e-312c-4c58-9d45-c3c7e63e2412
-- 业务分类: 收益与归因
-- 核心底层数仓表: MFACTGZ_BOND_CAMPISI_RESULT, MDIM_BOND_INFO, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 06】: 现金类持仓时序 (cashPositionTiming)
-- 对应执行契约 sqlCode: b9f4277e-2793-4a0d-b9ed-e665e4bbd717
-- 业务分类: 大类资产配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 07】: 商品期货板块收益贡献 (commodityFutures)
-- 对应执行契约 sqlCode: 6ff642c7-7364-4f0b-9e6b-a9d259b49d0e
-- 业务分类: 衍生品与期货
-- 核心底层数仓表: MFACTGZ_FUTURES_INCOME, MDIM_COMMODITY_PLATE, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 08】: 商品期货净敞口时序 (commodityFuturesExposureTiming)
-- 对应执行契约 sqlCode: a26dc9c7-6ca1-49f0-a93f-bceeedea3aee
-- 业务分类: 衍生品与期货
-- 核心底层数仓表: MFACTGZ_FUTURES_POSITION, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 09】: 期货十大盈利亏损品种 (commodityProfitLoss)
-- 对应执行契约 sqlCode: b0a11b9d-5709-4c27-a0c0-57e859b2d9e8
-- 业务分类: 衍生品与期货
-- 核心底层数仓表: MFACTGZ_FUTURES_INCOME_DETAIL, MDIM_FUTURES_CONTRACT
...
-- --------------------------------------------------------------------------------
-- 【模块 10】: 信用风险评级分布 (creditRiskRateDistribution)
-- 对应执行契约 sqlCode: 944d0936-066f-4d4c-ad16-67767a431d7a
-- 业务分类: 债券与固收
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_BOND_RATING, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 11】: 固定收益类持仓时序 (fixedPositionTiming)
-- 对应执行契约 sqlCode: 7c426689-80d2-4ce0-83d8-26c45fe5493f
-- 业务分类: 大类资产配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDTOTAL, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 12】: 组合加权久期时序 (fundDurationTiming)
-- 对应执行契约 sqlCode: 7d29ed40-0d69-4cd1-93a8-0a2bf9eac9cd
-- 业务分类: 债券与固收
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_BOND_INFO, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 13】: 持股数量时序变化图 (hldStockNumTime)
-- 对应执行契约 sqlCode: 2f3f7b80-5c28-407f-90c5-5d2464eaf5a0
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 14】: A股持仓指数及板块时序 (holdPlate)
-- 对应执行契约 sqlCode: caa5b2df-8278-458e-b176-db71cce9a024
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_STOCK_PLATE, MFACTEI_INDEX_MARKET
...
-- --------------------------------------------------------------------------------
-- 【模块 15】: 华泰柏瑞行业配置 (hsInduStockAlloca)
-- 对应执行契约 sqlCode: 4dadd10a-92c2-43b3-b8a7-de798cdebb5c
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_STOCK_INDUSTRY_ALLOC, MDIM_HS_INDUSTRY, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 16】: 华泰柏瑞行业分析 (hsInduStockAnal)
-- 对应执行契约 sqlCode: 73ab4b7f-b543-4b94-ac6c-50685997d361
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_BRINSON_INDUSTRY, MDIM_HS_INDUSTRY
...
-- --------------------------------------------------------------------------------
-- 【模块 17】: 华泰柏瑞行业估值 (hsInduStockVala)
-- 对应执行契约 sqlCode: 125bb87f-2c9c-485e-8042-87ce0d60cd30
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_STOCK_INDUSTRY_VALUATION, MDIM_HS_INDUSTRY
...
-- --------------------------------------------------------------------------------
-- 【模块 18】: 行业监控 (industryMonitor)
-- 对应执行契约 sqlCode: 8c627513-5936-4936-af12-66ad0ea1a947
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_INDUSTRY_INFO, MFACTEI_INDEX_MARKET
...
-- --------------------------------------------------------------------------------
-- 【模块 19】: 最大回撤与修复时序 (maxDrawdownFQ)
-- 对应执行契约 sqlCode: f6dd749d-df80-41d4-b98f-9ace45fb5544
-- 业务分类: 风险与回撤
-- 核心底层数仓表: MFACTGZ_FUND_NAV_TIMING, MFACTGZ_RISK_INDEX_RESULT
...
-- --------------------------------------------------------------------------------
-- 【模块 20】: 净值走势监控 (netValMonitor)
-- 对应执行契约 sqlCode: 8c757339-83c8-4e0b-adae-76e3cec96a8d
-- 业务分类: 净值与业绩
-- 核心底层数仓表: MFACTGZ_FUND_HLDTOTAL, MFACTEI_INDEX_MARKET, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 21】: 产品规模走势 (netValue)
-- 对应执行契约 sqlCode: 38ac7662-b120-4cb9-9fdf-8becaf856723
-- 业务分类: 净值与业绩
-- 核心底层数仓表: MFACTGZ_FUND_HLDTOTAL, MDIM_FUND_INFO
...
-- --------------------------------------------------------------------------------
-- 【模块 22】: 期货总持仓及收益 (overallFutures)
-- 对应执行契约 sqlCode: b435f30d-6914-4916-93d6-3c1e8d3e510e
-- 业务分类: 衍生品与期货
-- 核心底层数仓表: MFACTGZ_FUTURES_POSITION, MFACTGZ_FUTURES_INCOME
...
-- --------------------------------------------------------------------------------
-- 【模块 23】: 行业持仓分布 (positionIndustry)
-- 对应执行契约 sqlCode: d8ac50c1-b41c-498e-8c8a-bd6a577177a6
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_INDUSTRY_INFO, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 24】: 产品基本信息 (productInfo)
-- 对应执行契约 sqlCode: 4475dbc6-a3f9-4e37-bb8b-fda45fda68fc
-- 业务分类: 基础信息
-- 核心底层数仓表: MDIM_FUND_INFO, MDIM_COMPANY_INFO, ME_DIM
...
-- --------------------------------------------------------------------------------
-- 【模块 25】: 风险与收益指标 (rewardRisk)
-- 对应执行契约 sqlCode: f6dd749d-df80-41d4-b98f-9ace45fb5544
-- 业务分类: 风险与回撤
-- 核心底层数仓表: MFACTGZ_RISK_INDEX_RESULT, MFACTGZ_FUND_NAV_TIMING
...
-- --------------------------------------------------------------------------------
-- 【模块 26】: 风险指标分析 (riskValue)
-- 对应执行契约 sqlCode: 8abc19f5-f2c9-4cff-8a89-48884270d042
-- 业务分类: 风险与回撤
-- 核心底层数仓表: MFACTGZ_VAR_RESULT, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 27】: 股票净敞口时序 (stockExposureTiming)
-- 对应执行契约 sqlCode: 712b930b-87a5-4cba-8da0-3671d4c8dc54
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MFACTGZ_FUTURES_POSITION, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 28】: 申万行业配置 (swInduStockAlloca)
-- 对应执行契约 sqlCode: 76022f4b-f82e-4835-9882-b2e012e08b9d
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_SW_INDUSTRY, MFACTEI_INDEX_WEIGHT
...
-- --------------------------------------------------------------------------------
-- 【模块 29】: 申万行业分析 (swInduStockAnal)
-- 对应执行契约 sqlCode: 2ca96e54-2ca9-4726-8a5d-1d4d976d318d
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_BRINSON_SW_INDUSTRY, MDIM_SW_INDUSTRY
...
-- --------------------------------------------------------------------------------
-- 【模块 30】: 申万行业估值 (swInduStockVala)
-- 对应执行契约 sqlCode: cb7963e8-1401-4598-a791-2fd809a73f50
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_SW_INDUSTRY_VALUATION, MDIM_SW_INDUSTRY
...
-- --------------------------------------------------------------------------------
-- 【模块 31】: 前十大亏损行业 (tenLossIndustry)
-- 对应执行契约 sqlCode: 06842166-987d-4805-88b6-a5cce0cf3beb
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_STOCK_INDUSTRY_INCOME, MDIM_INDUSTRY_INFO
...
-- --------------------------------------------------------------------------------
-- 【模块 32】: 前十大盈利行业 (tenProfitIndustry)
-- 对应执行契约 sqlCode: fe842e36-d296-432d-8696-d6ec8f2aab03
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_STOCK_INDUSTRY_INCOME, MDIM_INDUSTRY_INFO
...
-- --------------------------------------------------------------------------------
-- 【模块 33】: 前五大行业时序 (topFiveIndustryTime)
-- 对应执行契约 sqlCode: 052a0166-713f-413f-9fee-d5f9230f813c
-- 业务分类: 行业分析与配置
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MDIM_INDUSTRY_INFO, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 34】: 前十大/前五大股票持仓时序 (topTenOrTopFiveStockPositionTime)
-- 对应执行契约 sqlCode: 8c0d7ee0-1887-4e43-90b5-2aac7578daae
-- 业务分类: 股票与权益
-- 核心底层数仓表: MFACTGZ_FUND_HLDDETAIL, MFACTGZ_FUND_HLDTOTAL, MDIM_SYS_TIME
...
-- --------------------------------------------------------------------------------
-- 【模块 35】: 交易行为分析 (tradeBehavior)
-- 对应执行契约 sqlCode: b377deb1-e137-44f5-9aa2-b840ec2f6f18
-- 业务分类: 交易与行为
-- 核心底层数仓表: MFACTGZ_FUND_TURNOVER, MFACTGZ_FUND_HLDTOTAL
...
-- --------------------------------------------------------------------------------
-- 【模块 36】: 区间交易分析 (tradeDuring)
-- 对应执行契约 sqlCode: d49ae5ec-675c-4ae2-808e-793eecee064f
-- 业务分类: 交易与行为
-- 核心底层数仓表: MFACTGZ_FUND_TRADE_FLOW, MDIM_SYS_TIME
